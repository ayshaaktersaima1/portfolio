            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                >
                    <div className="flex justify-between items-start mb-4">
                        ...
                        <a
                            href="https://skillswap-eta-eight.vercel.app/"
                            target="_blank"
                    ...
                    <p className="text-black/60 text-sm mb-6 leading-relaxed min-h-[60px]">
                        Full-stack skill-sharing platform where users can share skills,
                        connect with others and learn through skill exchange.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <a
                            href="https://skillswap-eta-eight.vercel.app/"
                            target="_blank"
                            className="px-3 py-1 rounded bg-purple-600 text-white text-[10px] font-bold"
                        >
                            Live Demo
                        </a>

                        <a
                            href="https://github.com/ayshaaktersaima1/skillswap"
                            target="_blank"
                        ...
                        <a
                            href="https://github.com/ayshaaktersaima1/skillswap-server"
                            target="_blank"
                ...
                >
                    ...
                    <p className="text-black/60 text-sm mb-6 leading-relaxed min-h-[60px]">
                        Full-stack car rental platform with authentication, booking system,
                        CRUD operations, protected routes and user profile-based features.
                    </p>
